...
function S3Helper(accessConfig, bucketName){
    ...
    this.accessKeyId = accessConfig.AWS_ACCESS_KEY;
    this.secretAccessKey = accessConfig.AWS_SECRET_ACCESS_KEY;
...
S3Helper.prototype.upload = function(filename){
    var promise = new Promise((resolve, reject)=>{ 
        var uploadParams = {Bucket: this.bucketName, Key: '', Body: '', ACL: "public-read"};
